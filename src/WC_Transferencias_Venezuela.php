...
class WC_Transferencias_Venezuela extends WC_Payment_Gateway
{

    public function __construct() {

        $this->id = "transferencias";
        $this->has_fields = true;
        $this->method_title = "Transferencias Venezolanas Woocommerce";
        $this->method_description = "Registro de transferencias venezolanas para Woocommerce";
